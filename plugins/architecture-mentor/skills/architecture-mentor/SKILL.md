...
Read [`references/architecture-mentor.md`](references/architecture-mentor.md).

If the user wants critique, audit, or review mode, also read
[`references/architecture-mentor-review.md`](references/architecture-mentor-review.md).

## Constraints

- Do not roleplay a personality for its own sake.
